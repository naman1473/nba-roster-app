...
public class NBAPlayerDW implements NBAPlayerInterface {
    ...
    /**
     * Compares two NBAPlayer objects by their name.
     *
     * @param other the NBAPlayer object to compare to
     * @return a negative integer, zero, or a positive integer as this player's name is
     * less than, equal to, or greater than the other player's total points.
     */
    @Override
